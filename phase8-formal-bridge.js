(function(){
  ...
  function installRightIssueStyles(){
    ...
    st.textContent = [
      ...
      'body.tm-phase8-formal .tmrp-stat b{color:#f2d98d;font-size:20px;line-height:1;font-variant-numeric:tabular-nums;letter-spacing:.02em;white-space:nowrap;text-shadow:0 1px 4px rgba(0,0,0,.5);}body.tm-phase8-formal .tmrp-stat span{margin-top:7px;color:rgba(232,220,187,.52);font-size:11px;letter-spacing:.12em;}',
      ...
      'body.tm-phase8-formal .tmrp-admin-shell{display:flex;flex-direction:column;gap:13px;color:#eadfbd;font-family:"STKaiti","KaiTi","楷体",serif;}body.tm-phase8-formal .tmrp-admin-card{box-shadow:inset 3px 0 var(--admin-c,rgba(201,168,95,.42));}body.tm-phase8-formal .tmrp-admin-title{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:8px;}body.tm-phase8-formal .tmrp-admin-title b{color:#f2d98d;font-size:15px;letter-spacing:.12em;}body.tm-phase8-formal .tmrp-admin-title small{color:rgba(232,220,187,.50);font-size:10px;text-align:right;line-height:1.45;}',
      ...
      'body.tm-phase8-formal .tmrp-ghost-label{text-align:center;color:rgba(232,220,187,.42);font-size:10.5px;letter-spacing:.16em;margin:2px 0 9px;}body.tm-phase8-formal .tmrp-ghost{opacity:.42;filter:grayscale(.25);pointer-events:none;display:flex;flex-direction:column;gap:8px;}'
    ].join('\n');
    document.head.appendChild(st);
  }
  ...
  function installStyles(){
    ...
    st.textContent = [
      ...
      'body.tm-phase8-formal .tm-rc-count{position:absolute;right:-4px;top:-5px;min-width:15px;height:15px;line-height:13px;padding:0 3px;border-radius:2px;background:linear-gradient(180deg,#c74a30,#811e10);border:1px solid rgba(245,190,122,.62);color:#ffe5c8;font:700 9px/13px "STSong","SimSun",serif;text-align:center;box-sizing:border-box;box-shadow:0 1px 4px rgba(0,0,0,.46),inset 0 1px 0 rgba(255,238,180,.20),inset 0 -1px 0 rgba(0,0,0,.34);letter-spacing:.04em;}',
