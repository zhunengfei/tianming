...
(function(){
  ...
  function injectStyles() {
    ...
    s.textContent = ''
      ...
      + '.p-harem .gs-harem-fav-val{font-size:0.66rem;color:#9a8a5a;width:18px;text-align:right;}'
      ...
      + '.p-harem .gs-harem-badge{display:inline-block;padding:1px 4px;font-size:0.65rem;border-radius:1px;letter-spacing:0;}'
