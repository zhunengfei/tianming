# 廷议大改 Sprint·v2.4 (三轮 audit·ceremony 分配 + name alias + tone spec)

date·2026-05-23·status·**ready for kickoff** (v2.3 + 6 处三轮修订)
预算·**22.4 - 25.4d** · 关键路径 ~14d (vs v2.3 +0.3d·Slice 7.5 接 5 ceremony)
...
**关键路径** (must-be-sequential)·Slice 0 → 0.5 → 2 → 10a → 2.5 → 3 → 4 → 4.5 → 5 → 6 → 11 = **~14d** (v2.4 不变·Slice 7.5 +0.3d 在并行支路·不影响关键路径)
