# 廷议大改 Sprint·v2.2 (3-slice 对齐·hard bug 修)

date·2026-05-23·status·**ready for kickoff** (v2.1 + 12 处对齐修订·亲读 v3 verified)
预算·**23.5 - 26.5d** · 关键路径 ~14.5d (vs v2.1 +0.7d)
...
**关键路径** (must-be-sequential)·Slice 0 → 0.5 → 2 → 10a → 2.5 → 3 → 4 → 4.5 → 5 → 6 → 11 = **~14.5d** (v2.2 +0.5d·0.5 + 10a 加入 critical path)
...
5. conveningPolitics.tilt 二次惩罚正确触发·schema 见 §5.5
