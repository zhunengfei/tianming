# 廷议大改 Sprint·v2.6 (五轮 audit·Slice 3 stance hybrid 锁 + §6 schema 收口)

date·2026-05-23·status·**ready for kickoff** (v2.5 + 7 处五轮修订·**含 Slice 3 paradigm = hybrid**)
预算·**23.75 - 27.55d** · 关键路径 ~15d (vs v2.5 +1.35-1.85d·Slice 3 paradigm change + §6 schema 修)
...
**关键路径** (must-be-sequential)·Slice 0 (+0.0a/0.0b) → 0.5 → 2 → 10a → 2.5 → 3 → 4 → 4.5 → 5 → 6 → 11 = **~15-16d** (v2.6 +1.2d·Slice 3 hybrid paradigm 1.5d → 2.7d)·Slice 1/7.5 各 +0.1-0.2d 在并行支路·不影响关键路径
