# 廷议大改 Sprint·v2.8 (七轮 audit·trait naming convention 收口 + §5.4 算法 + helper spec)

date·2026-05-23·status·**ready for kickoff** (v2.7 + 7 处七轮修订·**含 1 catastrophic·trait naming 14→50 全写**)
预算·**25.1 - 28.9d** · 关键路径 ~15.7d (vs v2.7 +0.65d·trait BIAS 重写 + 5 helper spec)
