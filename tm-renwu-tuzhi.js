...
'#tm-zhi-overlay .chip{font-size:11px;letter-spacing:0.05em;padding:3px 10px;border-radius:11px;border:1px solid var(--gold-d);background:rgba(255,250,235,0.7);color:var(--ink-soft);white-space:nowrap;}',
...
'#tm-zhi-overlay .panel-hd span{font-size:10px;color:var(--ink-faint);}',
...
'#tm-zhi-overlay .stat span{font-size:9px;color:var(--ink-faint);}',
...
'#tm-zhi-overlay .r-sel{flex:1;min-width:0;font-family:var(--zfont);font-size:10.5px;color:var(--ink-soft);padding:5px 6px;border:1px solid rgba(168,131,58,0.3);border-radius:7px;background:rgba(255,252,242,0.6);cursor:pointer;outline:none;}',
'#tm-zhi-overlay .r-meta{display:flex;align-items:center;justify-content:space-between;font-size:10px;color:var(--ink-faint);}',
...
'#tm-zhi-overlay .fac-hdr{display:flex;align-items:center;gap:7px;font-size:11px;letter-spacing:0.1em;color:var(--ink-soft);margin:9px 3px 6px;padding-left:8px;border-left:3px solid var(--fc,var(--gold));}',
'#tm-zhi-overlay .fac-hdr:first-child{margin-top:2px;}',
'#tm-zhi-overlay .fac-hdr .n{font-size:9.5px;color:var(--ink-faint);background:rgba(168,131,58,0.13);border-radius:8px;padding:0 6px;}',
'#tm-zhi-overlay .pcard{position:relative;display:flex;gap:9px;width:100%;text-align:left;cursor:pointer;font-family:var(--zfont);padding:8px 9px;border-radius:9px;border:1px solid rgba(168,131,58,0.2);background:linear-gradient(120deg,var(--silk-hi),var(--silk) 80%);margin-bottom:6px;transition:transform .15s,border-color .15s,box-shadow .15s;overflow:hidden;}',
...
'#tm-zhi-overlay .pc-name .zi{font-size:10px;color:var(--ink-faint);}',
'#tm-zhi-overlay .pc-name .age{font-size:9.5px;color:var(--ink-faint);margin-left:auto;}',
'#tm-zhi-overlay .pc-off{font-size:10.5px;color:var(--ink-soft);margin:2px 0 4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}',
'#tm-zhi-overlay .pc-off .rk{color:var(--gold-d);}',
'#tm-zhi-overlay .pc-bars{display:flex;gap:7px;margin-bottom:4px;}',
'#tm-zhi-overlay .pc-bar{flex:1;display:flex;align-items:center;gap:3px;font-size:9px;color:var(--ink-faint);}',
...
'#tm-zhi-overlay .ptag{font-size:9px;padding:1px 6px;border-radius:8px;border:1px solid rgba(168,131,58,0.3);background:rgba(255,252,242,0.6);color:var(--ink-soft);}',
...
'#tm-zhi-overlay .pc-star{color:var(--gold-d);font-size:11px;margin-right:2px;}',
...
'#tm-zhi-overlay .dh-mount-cap{text-align:center;font-size:10px;color:var(--ink-faint);letter-spacing:0.2em;margin-top:7px;}',
'#tm-zhi-overlay .dh-colophon{writing-mode:vertical-rl;text-orientation:upright;font-family:var(--zfont-doc);font-size:10.5px;letter-spacing:0.18em;color:var(--ink-faint);height:150px;line-height:1.5;max-height:150px;overflow:hidden;border-left:1px solid rgba(168,131,58,0.2);padding-left:3px;}',
...
'#tm-zhi-overlay .dh-pill{font-size:11px;padding:3px 11px;border-radius:11px;border:1px solid rgba(168,131,58,0.34);background:rgba(255,252,242,0.65);color:var(--ink-soft);}',
...
'#tm-zhi-overlay .situation .stx b{font-size:12.5px;}#tm-zhi-overlay .situation .stx span{font-size:10.5px;opacity:0.85;margin-left:6px;}',
...
'#tm-zhi-overlay .dh-heart span{font-size:10px;color:var(--ink-faint);letter-spacing:0.1em;}',
...
'#tm-zhi-overlay .dh-loy .lbl{font-size:10px;color:var(--ink-faint);letter-spacing:0.2em;margin-top:1px;}',
...
'#tm-zhi-overlay .verdict::before{content:"御 览";position:absolute;left:-1px;top:-10px;font-size:10px;letter-spacing:0.1em;color:#fff;background:linear-gradient(150deg,var(--vermilion),var(--cinnabar-d));padding:2px 8px;border-radius:4px;}',
...
'#tm-zhi-overlay .sec-t small{font-weight:normal;color:var(--ink-faint);font-size:10px;letter-spacing:0.04em;margin-left:auto;}',
...
'#tm-zhi-overlay .mingpan .cap{font-size:11px;letter-spacing:0.16em;color:var(--ink-soft);margin-top:2px;}',
'#tm-zhi-overlay .bars{display:grid;grid-template-columns:1fr 1fr;gap:8px 16px;}',
'#tm-zhi-overlay .bar{font-size:11px;color:var(--ink-soft);}',
...
'#tm-zhi-overlay .idcell span{display:block;font-size:9.5px;color:var(--ink-faint);letter-spacing:0.06em;margin-bottom:2px;}',
...
'#tm-zhi-overlay .dualbox .lb{font-size:10px;letter-spacing:0.16em;color:var(--dc,var(--gold-d));margin-bottom:5px;}',
'#tm-zhi-overlay .dualbox .v{font-size:13px;color:var(--ink);margin-bottom:3px;}',
'#tm-zhi-overlay .dualbox .s{font-size:11px;color:var(--ink-soft);line-height:1.6;}',
...
'#tm-zhi-overlay .trait{font-size:11px;padding:3px 11px;border-radius:11px;border:1px solid rgba(168,131,58,0.3);background:rgba(255,252,242,0.6);color:var(--ink-soft);}',
...
'#tm-zhi-overlay .fnote{font-size:10.5px;color:var(--ink-faint);line-height:1.6;margin-top:8px;}',
...
'#tm-zhi-overlay .risk span{display:block;font-size:9px;color:var(--ink-faint);}',
...
'#tm-zhi-overlay .relrow .lbl{font-size:10.5px;padding:1px 8px;border-radius:8px;}',
...
'#tm-zhi-overlay .relrow .sc{font-size:10px;color:var(--ink-faint);font-variant-numeric:tabular-nums;margin-left:auto;}',
...
'#tm-zhi-overlay .wcdot small{position:absolute;bottom:-13px;font-size:8px;color:var(--ink-faint);font-variant-numeric:tabular-nums;}',
...
'#tm-zhi-overlay .opinion .brk{font-size:11px;color:var(--ink-faint);}',
...
'#tm-zhi-overlay .egolegend{display:flex;gap:16px;justify-content:center;margin-top:6px;font-size:10.5px;color:var(--ink-faint);flex-wrap:wrap;}',
...
'#tm-zhi-overlay .tlrow .yr{font-size:10px;color:var(--gold-d);font-variant-numeric:tabular-nums;}',
'#tm-zhi-overlay .tlrow .ti{font-size:12.5px;color:var(--ink);margin:1px 0;}',
'#tm-zhi-overlay .tlrow .ds{font-size:11px;color:var(--ink-soft);line-height:1.6;}',
'#tm-zhi-overlay .domains{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:9px;}',
'#tm-zhi-overlay .dom{font-size:10.5px;padding:2px 9px;border-radius:9px;background:rgba(168,131,58,0.1);color:var(--ink-soft);border:1px solid rgba(168,131,58,0.2);}',
...
'#tm-zhi-overlay .mem .t{font-size:10px;color:var(--ink-faint);font-variant-numeric:tabular-nums;flex:0 0 auto;}',
'#tm-zhi-overlay .mem .ev{color:var(--ink-soft);line-height:1.55;}',
'#tm-zhi-overlay .mem .who{color:var(--indigo);font-size:10px;}',
'#tm-zhi-overlay .archive-toggle{font-size:11px;color:var(--gold-d);cursor:pointer;padding:6px 4px;}',
...
'#tm-zhi-overlay .work .mt{font-size:10px;color:var(--ink-faint);margin-top:2px;}',
'#tm-zhi-overlay .fttitle small{font-size:10px;color:var(--ink-faint);letter-spacing:0.04em;}',
...
'#tm-zhi-overlay .ft-legend{display:flex;gap:16px;justify-content:center;margin-top:8px;font-size:10.5px;color:var(--ink-faint);}',
...
'#tm-zhi-overlay .clan-it .lb{font-size:9.5px;color:var(--ink-faint);letter-spacing:0.1em;margin-bottom:4px;}',
...
'#tm-zhi-overlay .cj-bar span{height:100%;display:flex;align-items:center;justify-content:center;font-size:9.5px;color:#fff;white-space:nowrap;overflow:hidden;text-shadow:0 1px 1px rgba(0,0,0,0.3);}',
...
'#tm-zhi-overlay .cj-card .ct .pw{font-size:10px;color:var(--ink-faint);}',
'#tm-zhi-overlay .cj-members{display:flex;flex-wrap:wrap;gap:5px;}',
'#tm-zhi-overlay .cj-mem{font-size:11px;padding:2px 9px;border-radius:9px;border:1px solid rgba(168,131,58,0.26);background:rgba(255,252,242,0.6);color:var(--ink-soft);cursor:pointer;transition:all .14s;}',
...
'#tm-zhi-overlay .cj-legend{display:flex;gap:16px;justify-content:center;margin:8px 0 2px;font-size:10.5px;color:var(--ink-faint);flex-wrap:wrap;}',
...
'#tm-zhi-overlay .ph-ctrl .lb{font-size:11px;color:var(--ink-faint);letter-spacing:0.06em;}',
'#tm-zhi-overlay .phb{font-family:var(--zfont);font-size:11px;cursor:pointer;padding:5px 12px;border-radius:7px;border:1px solid rgba(168,131,58,0.3);background:rgba(255,252,242,0.55);color:var(--ink-soft);transition:all .14s;}',
...
'#tm-zhi-overlay .ph-table th{font-size:10.5px;color:var(--ink-faint);font-weight:normal;letter-spacing:0.06em;text-align:center;padding:7px 5px;border-bottom:1px solid rgba(168,131,58,0.3);}',
...
'#tm-zhi-overlay .ph-name small{color:var(--ink-faint);font-size:10px;margin-left:5px;}',
...
'#tm-zhi-overlay .cmp-head h2 small{font-size:11px;color:var(--ink-faint);letter-spacing:0.04em;margin-left:8px;}',
...
'#tm-zhi-overlay .cmp-person .of{font-size:11px;color:var(--ink-soft);margin-top:2px;}',
'#tm-zhi-overlay .cmp-person .fa{font-size:10.5px;margin-top:3px;}',
'#tm-zhi-overlay .cmp-drop{position:absolute;right:7px;top:7px;width:18px;height:18px;border-radius:5px;border:1px solid rgba(168,131,58,0.34);background:rgba(255,252,242,0.85);color:var(--ink-faint);font-size:11px;display:grid;place-items:center;cursor:pointer;z-index:2;}',
...
'#tm-zhi-overlay .cmpbarN{display:grid;grid-template-columns:48px 1fr;align-items:center;gap:10px;margin-bottom:10px;font-size:11px;}',
...
'#tm-zhi-overlay .cwbar b{font-variant-numeric:tabular-nums;font-size:11px;width:26px;text-align:right;}',
...
'#tm-zhi-overlay .zhubi::before{content:"御 笔";position:absolute;left:-1px;top:-10px;font-size:10px;letter-spacing:0.1em;color:#fff;background:linear-gradient(150deg,var(--vermilion),var(--cinnabar-d));padding:2px 8px;border-radius:4px;}',
...
'#tm-zhi-overlay .zhubi .zb-edit{position:absolute;right:10px;top:8px;font-size:11px;color:var(--cinnabar-d);cursor:pointer;border:1px solid rgba(184,58,43,0.3);border-radius:6px;padding:2px 9px;background:rgba(255,252,243,0.7);}',
...
'#tm-zhi-overlay .zhubi .zb-acts button{font-family:var(--zfont);font-size:11px;cursor:pointer;padding:4px 12px;border-radius:6px;border:1px solid rgba(168,131,58,0.4);background:rgba(255,252,243,0.6);color:var(--ink-soft);}',
...
function adaptChar(c){
  ...
  return {
    _ref:c, name:c.name, zi:c.zi||c.courtesy||'', title:c.title, officialTitle:c.officialTitle, role:c.role, rank:c.rank,
    ...
    mingwang:(c.mingwang!=null?Math.round(c.mingwang):(c.reputation!=null?Math.round(c.reputation):null)), xianneng:(c.xianneng!=null?Math.round(c.xianneng):null),
    wuchang:c.wuchang||{}, traits:adaptTraits(c),
...
function pcard(p){
  ...
  return '<button class="pcard'+(p.name===state.sel?' active':'')+(p.alive===false?' dead':'')+(isPinned(p.name)?' pinned':'')+'" style="--fc:'+fc+'" onclick="TMZhi.selectP(\''+esc(p.name).replace(/'/g,"\\'")+'\')">'
    ...
    +'<span class="pc-off">'+esc(p.officialTitle||p.title||'布衣')+' <span class="rk">'+esc(p.rank||'')+'</span></span>'
...
function dossierHead(p){
  ...
  return '<div class="dossier-head"><div class="dh-loy">'+loyRing(p.loyalty,74)+'<div class="lbl">忠诚</div></div>'
    ...
    +'<div class="dh-pills"><span class="dh-pill fac">'+esc(p.faction)+'</span>'+(p.party?'<span class="dh-pill">'+esc(p.party)+'</span>':'')+'<span class="dh-pill rank">'+esc(p.rank||'')+'</span><span class="dh-pill">'+esc(p.officialTitle||p.title||'布衣')+'</span></div>'
    +situationBanner(p)
...
function tabOverview(p){
  ...
  var bars=[['忠诚',p.loyalty,'#557f6f','#6fa291'],['野心',p.ambition,'#8e6aa8','#a98ac4'],['压力',p.stress,'#a83228','#c64a3e'],['康健',p.health,'#7d5e22','#d8b96a'],['廉介',p.integrity,'#557f6f','#6fa291'],['名望',p.mingwang,'#7d5e22','#d8b96a'],['贤能',p.xianneng,'#4a5e8a','#7388b8']];
...
function tabIdentity(p){
  ...
  return '<section class="sec full"><div class="sec-t">身 份 档 案</div><div class="idgrid">'
    ...
    +'</div></section>'
    +'<div class="dual"><div class="dualbox" style="--dc:var(--gold-d)"><div class="lb">公 职 身 份</div><div class="v">'+esc(p.officialTitle||p.title||'布衣')+'</div><div class="s">'+esc(p.faction)+(p.party?' · '+esc(p.party)+(p.partyRank?'（'+esc(p.partyRank)+'）':''):'')+' · '+esc(p.rank||'')+'</div></div>'
...
function tabRelations(p){
  ...
  html+='<div class="dgrid"><section class="sec"><div class="sec-t">对 他 人 印 象</div><div class="rows">'+((p.impressions||[]).map(function(im){var col=im.favor>=0?'good':'bad';return '<div class="row"><span class="k">'+esc(im.name)+'</span><span class="v"><span class="lbl '+col+'" style="font-size:11px;padding:1px 8px;border-radius:8px">'+esc(im.label)+'（'+(im.favor>0?'+':'')+im.favor+'）</span></span></div>';}).join('')||'<div class="prose">暂无印象记录。</div>')+'</div></section>'
...
function tabBenji(p){
  ...
  (p.arcs||[]).slice().sort(function(a,b){return a.turn-b.turn;}).forEach(function(a){nodes.push({when:'T'+a.turn,ti:a.type,ds:a.desc,arc:true,tag:'近事'});});
  var ribbon=nodes.length?('<div style="overflow-x:auto;padding:30px 6px 14px"><div style="position:relative;display:inline-flex;align-items:flex-start;min-width:100%">'+nodes.map(function(nd){return '<div class="tlrow" style="flex:0 0 auto;width:150px;padding:0 10px;border:none"><div class="ti">'+esc(nd.when||'')+'</div><div class="sec" style="margin:6px 0 0;padding:8px 10px"><span style="font-size:9px;color:var(--ink-faint);border:1px solid rgba(168,131,58,0.3);border-radius:7px;padding:0 6px">'+esc(nd.tag)+'</span><div style="font-size:12.5px;color:'+(nd.key?'var(--cinnabar-d)':'var(--ink)')+';margin:3px 0">'+esc(nd.ti||'')+'</div><div class="ds">'+esc(nd.ds||'')+'</div></div></div>';}).join('')+'</div></div>'):'<div class="stub">暂无编年事迹。</div>';
...
function tabFamily(p){
  var tier={imperial:'皇族',noble:'世家',gentry:'士族',common:'寒门'},renown=p.familyTier==='imperial'?100:p.familyTier==='gentry'?60:p.familyTier==='noble'?78:40;
  var clanGrid=[['门第',tier[p.familyTier]||'—',null],['族丁',(p.bloodRelatives||[]).filter(function(m){return !m.self;}).length,null],['家望',renown,renown],['家族',p.family||'—',null]];
  var harem='';
...
function tabMemory(p){
  ...
  var arcHtml=(p.arcs||[]).map(function(a){return '<div class="tlrow"><div class="yr">T'+a.turn+' · '+esc(a.type)+'</div><div class="ds">'+esc(a.desc)+'</div></div>';}).join('')||'<div class="stub">暂无角色弧线。</div>';
...
var PH_DIMS=[['loyalty','忠诚'],['xianneng','贤能'],['ambition','野心'],['stress','压力'],['mingwang','名望'],['integrity','廉介'],['military','军事'],['administration','政务']];
...
function renderCompare(){
  ...
  var metrics=[['忠诚','loyalty'],['野心','ambition'],['压力','stress'],['康健','health'],['名望','mingwang'],['贤能','xianneng'],['廉介','integrity']];
  ...
  var byLoy=ppl.slice().sort(function(a,b){return b.loyalty-a.loyalty;}),byXian=ppl.slice().sort(function(a,b){return (b.xianneng||0)-(a.xianneng||0);});
  var verdictTxt='<b>权衡：</b>'+esc(byLoy[0].name)+'忠诚最笃（'+Math.round(byLoy[0].loyalty)+'）'+(byLoy[0].ambition>=70?'，然野心炽盛宜防尾大；':'，且野心尚可控驭；')+'　'+esc(byXian[0].name)+'才略最优，可委以繁剧。';
  var miniP=function(p,i){return '<div class="cmp-person '+clsn[i]+'" style="border-left-color:'+cols[i]+'">'+(i>0?'<span class="cmp-drop" onclick="TMZhi.dropCompare('+i+')" title="移出对参">✕</span>':'')+'<div class="cmp-face">'+faceHtml(p)+'</div><div><div class="nm">'+esc(p.name)+'</div><div class="of">'+esc(p.officialTitle||p.title||'布衣')+' · '+esc(p.rank||'')+'</div><div class="fa" style="color:'+cols[i]+'">'+esc(p.faction)+(p.party?' · '+esc(p.party):'')+'</div></div></div>';};
...
function closePanel(){var ov=document.getElementById('tm-zhi-overlay');if(ov)ov.style.display='none';document.documentElement.style.overflow='';}
...
var TMZhi={
  ...
  exportBio:function(){var p=findP(state.sel);if(!p){toast('未选人物');return;}var L=['【'+p.name+(p.zi?'　字'+p.zi:'')+'】',(p.officialTitle||p.title||'布衣')+'　'+(p.rank||'')+'　'+(p.faction||'')+(p.party?'·'+p.party:''),(p.appearance?'〔形貌〕'+p.appearance:''),(p.bio?'〔传略〕'+p.bio:''),'〔志向〕'+(p.personalGoal||'—')].filter(Boolean);try{var blob=new Blob([L.join('\n')],{type:'text/plain;charset=utf-8'}),a=document.createElement('a');a.href=URL.createObjectURL(blob);a.download=p.name+'·列传.txt';document.body.appendChild(a);a.click();a.remove();toast('已导出 '+p.name+' 列传');}catch(e){toast('导出失败');}},
  ...
  onSearch:function(v){state.q=v;var a=q('#tm-zhi-gsearch'),b=q('#tm-zhi-rsearch');if(a&&a.value!==v)a.value=v;if(b&&b.value!==v)b.value=v;renderRoster();},
